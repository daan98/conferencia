...
$(function () {
  ...
  // ANIMANDO NÚMEROS
  $(".general-information .information:nth-child(1) h1").animateNumber(
    { number: 6 },
    2000
  );
  $(".general-information .information:nth-child(2) h1").animateNumber(
    { number: 15 },
    2000
  );
  $(".general-information .information:nth-child(3) h1").animateNumber(
    { number: 3 },
    2000
  );
  $(".general-information .information:nth-child(4) h1").animateNumber(
    { number: 9 },
    2000
  );
